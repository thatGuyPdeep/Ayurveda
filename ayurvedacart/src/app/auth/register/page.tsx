...
import { Crown, Mail, Lock, Eye, EyeOff, User, Phone } from 'lucide-react'
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              className="block w-full px-3 py-3 border border-sage-dark rounded-xl bg-white/80 backdrop-blur-sm text-charcoal placeholder-charcoal/50 focus:outline-none focus:ring-2 focus:ring-emerald-800 focus:border-emerald-800 transition-all duration-200"
      ...
      <div className="space-y-4">
        <div className="flex items-start">
          <input
            ...
            onChange={handleInputChange}
            className="h-4 w-4 text-emerald-800 focus:ring-emerald-800 border-sage-dark rounded mt-1"
          />
          <label htmlFor="agreeToTerms" className="ml-3 block text-sm text-charcoal/70">
            I agree to the{' '}
            <Link href="/terms" className="text-emerald-800 hover:text-emerald-700 underline">
              Terms of Service
            </Link>{' '}
            and{' '}
            <Link href="/privacy" className="text-emerald-800 hover:text-emerald-700 underline">
              Privacy Policy
            </Link>
          </label>
        </div>
        ...
        <div className="flex items-start">
          <input
            ...
            className="h-4 w-4 text-emerald-800 focus:ring-emerald-800 border-sage-dark rounded mt-1"
          />
          <label htmlFor="subscribeNewsletter" className="ml-3 block text-sm text-charcoal/70">
            Subscribe to our newsletter for wellness tips and special offers
          </label>
        </div>
      </div>
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-ivory text-charcoal/60">Or register with</span>
          </div>
        </div>
